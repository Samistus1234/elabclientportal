...
export default function RecruiterLogin() {
    ...
    useEffect(() => {
        if (searchParams.get('registered') === 'recruiter') {
        ...
        if (error) {
            ...
            try {
                ...
                if (userInfo?.user_type === 'recruiter') {
                    ...
                    // If institutional contact lands here, redirect to contact portal
                    navigate('/contact/dashboard', { replace: true })
                } else {
                    // If regular client lands here, show error
                    setError('This login is for recruiter partners only. Please use the Client Portal.')
                    setIsLoading(false)
                }
            } catch {
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col justify-between w-full p-12">
                    ...
                    <div className="space-y-8">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-purple-300 text-sm font-medium mb-4">
                ...
                >
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="text-slate-600">
                            Track candidates and manage your referrals
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <div className="relative group">
                                    <div className={`absolute -inset-0.5 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl opacity-0 group-hover:opacity-30 blur transition-all duration-300 ${focusedField === 'email' ? 'opacity-50' : ''}`} />
                            ...
                            <div>
                                ...
                                <div className="relative group">
                                    <div className={`absolute -inset-0.5 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl opacity-0 group-hover:opacity-30 blur transition-all duration-300 ${focusedField === 'password' ? 'opacity-50' : ''}`} />
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full pl-12 pr-12 py-3.5 rounded-xl border border-slate-200 bg-white focus:border-indigo-400 focus:ring-4 focus:ring-indigo-100 transition-all outline-none text-slate-800 placeholder:text-slate-400"
                                        />
                                        <button
                                            type="button"
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.99 }}
                                className="w-full py-4 px-6 rounded-xl bg-gradient-to-r from-indigo-600 via-indigo-500 to-purple-500 text-white font-semibold hover:from-indigo-700 hover:via-indigo-600 hover:to-purple-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg shadow-indigo-500/30"
                            >
                                {isLoading ? (
                        ...
                        <div className="mt-6 pt-6 border-t border-slate-100">
                            <p className="text-center text-slate-600 text-sm">
                                New recruiter partner?{' '}
                                <Link to="/recruiter/register" className="text-indigo-600 hover:text-indigo-700 font-semibold hover:underline">
                                    Register here
                                </Link>
                            </p>
                        </div>
                    ...
                    {/* Info Box */}
                    <div className="mt-6 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-indigo-100">
                        <p className="text-sm text-slate-600 text-center">
                            This portal is exclusively for recruiter partners who refer candidates to ELAB for healthcare licensing services.
                        </p>
                    </div>
                    ...
                    <p className="text-center text-slate-400 text-xs mt-6">
                        Need help? Contact{' '}
                        <a href="mailto:support@elabsolution.org" className="hover:text-indigo-500 transition-colors">
                            support@elabsolution.org
                        </a>
                    </p>
                    <div className="flex items-center justify-center gap-3 mt-2 text-xs text-slate-400">
                        <a href="tel:+2348165634195" className="hover:text-indigo-500 transition-colors">
                            +234 816 563 4195
                        </a>
                        <span>•</span>
                        <a href="tel:+19294192327" className="hover:text-indigo-500 transition-colors">
                            +1 (929) 419-2327
                        </a>
                    </div>
                </motion.div>
