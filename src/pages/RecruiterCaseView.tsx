...
Generated by ELAB Client Portal
                ...
                >
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h3 className="font-semibold text-slate-800">Recommended Services</h3>
                            <p className="text-sm text-slate-500">Additional services for your candidate</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {caseData.out_pipeline_name?.toLowerCase().includes('mumaris') && (
                            <div className="bg-white rounded-xl p-4 border border-slate-200 hover:border-indigo-300 hover:shadow-md transition-all">
                                ...
                                <p className="text-sm text-slate-500 mb-3">
                                    Primary source verification for healthcare credentials
                                </p>
                                <a
                                    href="mailto:headoffice@elabsolution.org?subject=DataFlow%20Service%20Request%20for%20"
                        ...
                        <div className="bg-white rounded-xl p-4 border border-slate-200 hover:border-indigo-300 hover:shadow-md transition-all">
                            ...
                            <p className="text-sm text-slate-500 mb-3">
                                Professional exam scheduling and preparation support
                            </p>
                            <a
                                href="mailto:headoffice@elabsolution.org?subject=Prometric%20Exam%20Booking%20Request"
                                className="inline-flex items-center gap-1 text-sm font-medium text-indigo-600 hover:text-indigo-700"
                            >
                                Request Service <ArrowRight className="w-4 h-4" />
                            </a>
                        ...
                        <div className="bg-white rounded-xl p-4 border border-slate-200 hover:border-indigo-300 hover:shadow-md transition-all">
                            ...
                            <h4 className="font-semibold text-slate-800 mb-1">Trumerit Evaluation</h4>
                            <p className="text-sm text-slate-500 mb-3">
                                Credential evaluation for international qualifications
                            </p>
                            <a
                                href="mailto:headoffice@elabsolution.org?subject=Trumerit%20Evaluation%20Request"
                                className="inline-flex items-center gap-1 text-sm font-medium text-indigo-600 hover:text-indigo-700"
                            >
                                Request Service <ArrowRight className="w-4 h-4" />
                            </a>
                        ...
                        <div className="bg-white rounded-xl p-4 border border-slate-200 hover:border-indigo-300 hover:shadow-md transition-all">
                            ...
                            <p className="text-sm text-slate-500 mb-3">
                                UAE healthcare authority licensing assistance
                            </p>
                            <a
                                href="mailto:headoffice@elabsolution.org?subject=HAAD%20DHA%20Licensing%20Request"
                                className="inline-flex items-center gap-1 text-sm font-medium text-indigo-600 hover:text-indigo-700"
                            >
                                Request Service <ArrowRight className="w-4 h-4" />
                            </a>
                    ...
                    <div className="mt-6 p-4 bg-white/70 rounded-xl border border-indigo-200 text-center">
                        ...
                        <a
                            href="mailto:headoffice@elabsolution.org?subject=Custom%20Package%20Inquiry"
