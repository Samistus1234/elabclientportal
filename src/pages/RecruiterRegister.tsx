                ...
                >
                    ...
                    <div className="flex items-center justify-center gap-3 mb-6">
                        ...
                        <div className={`w-12 h-1 rounded-full transition-all ${
                            step === 'register' ? 'bg-gradient-to-r from-green-400 to-indigo-400' : 'bg-slate-200'
                        }`} />
                        <div className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all ${
                            step === 'register'
                                ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg shadow-indigo-200'
                                ...
                                >
                                    ...
                                    <form onSubmit={handleVerify} className="space-y-5">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative group">
                                                <div className={`absolute -inset-0.5 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl opacity-0 group-hover:opacity-30 blur transition-all duration-300 ${focusedField === 'company' ? 'opacity-50' : ''}`} />
                                                <div className="relative">
                                ...
                                >
                                    ...
                                    {verificationData && (
                                        <motion.div
                                            ...
                                            className="p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl mb-5 border border-indigo-100"
                                        >
                                            <p className="text-sm text-indigo-800 font-medium">
                                                Welcome, {verificationData.person?.first_name || verificationData.recruiter?.contact_name || 'Recruiter'}!
                                            </p>
                                    ...
                                    <form onSubmit={handleRegister} className="space-y-5">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative group">
                                                <div className={`absolute -inset-0.5 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl opacity-0 group-hover:opacity-30 blur transition-all duration-300 ${focusedField === 'confirmPassword' ? 'opacity-50' : ''}`} />
                                                <div className="relative">
                                                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400" />
                                                    <input
                                                        id="confirmPassword"
                    ...
                    <p className="text-center text-slate-400 text-xs mt-6">
                        Need help? Contact{' '}
                        <a href="mailto:headoffice@elabsolution.org" className="hover:text-indigo-500 transition-colors">
